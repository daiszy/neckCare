...
public class SampleService extends Service {
   ...
   /* private void showNotification() {
        ...
        notification.setLatestEventInfo(this, getText(R.string.sample_service_label), text, contentIntent);
    ...
    private void init() {
        ...
        filter.addAction("com.a.vegetables_source.alarm");
        registerReceiver(alarmReceiver, filter);

        Intent intent = new Intent();
        intent.setAction("com.a.vegetables_source.alarm");
    ...
    BroadcastReceiver alarmReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.a.vegetables_source.alarm".equals(intent.getAction())) {
