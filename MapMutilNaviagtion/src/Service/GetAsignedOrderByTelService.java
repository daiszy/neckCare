...
public class GetAsignedOrderByTelService {

	public List<Map<String,Object>> getAsignedOrdersByTel(String telphone) {
		List<Map<String,Object>> lists= new ArrayList<Map<String,Object>>();
		
		String sql = "select * from OrderInfo where Status = 1 and UserTel ='"+telphone+"'";
		//获取DB对象
